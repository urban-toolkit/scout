...
const ComparisonNode = memo(function ComparisonNode(
  ...
  // shows results. Comparison is always a terminal node in this app's
  // connection rules (nothing reads its output), so this is fire-and-forget
  // rather than awaiting the fetch below to resolve.
